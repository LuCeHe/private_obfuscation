...
metrics_oi_ = ['mean_bert_similarity', 'mean_jaccard_similarity', 'mean_szymkiewicz_similarity', 'map', 'nDCG@10', 'nDCG@100', 'P@10', 'P@100']
    ...
    for ref in refs:
        ...
        for dataset in datasets_oi:
            for metric in metrics_oi:
                ...
                row.append(f'{df[mask][metric].mean():.3f}')
        rows.append(row)
...
for dataset in all_datasets:
    create_table(df, refs, [dataset], metrics_oi_)